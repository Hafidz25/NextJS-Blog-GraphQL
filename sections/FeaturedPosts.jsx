...
const FeaturedPosts = () => {
  ...
  //   <div className="absolute arrow-btn left-0 transform hover:-translate-x-2 text-center py-3 cursor-pointer bg-gray-600 rounded-full">
  //     <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  //       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
  //     </svg>
  //   </div>
  // );
